...
public class ProductController {
    ...
    public ResponseEntity< List<Product>> getProductsByParameters(@PathVariable String additional){
        return ResponseEntity.ok().body(productService.getProductsByAdditional(additional));
    }
